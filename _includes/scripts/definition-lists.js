    ...
    */
    ...
    $dls.each(function() {
      ...
      $dl.find('dt').each(function(i) {
        ...
        + '<h4 class="card-title h5 m-0">' + $dt.html().replace(/(\([^()]*\))/g, '<span class="text-muted">$1</span>').replace(/\[([^\[\]]*)\]/g, '<span class="text-info">$1</span>') + '</h4>'
        + '</div>'
        + '</div>'
        + '<div class="card bg-white text-dark">'
        + '<div class="card-body">'
        + '<h4 class="card-title h5 mb-0">' + $dt.html().replace(/(\([^()]*\))/g, '<span class="text-muted">$1</span>').replace(/\[([^\[\]]*)\]/g, '<span class="text-info">$1</span>') + '</h4>'
        + '<p class="card-text">'
